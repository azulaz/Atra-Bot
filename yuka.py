...
async def help(ctx):
    embed = discord.Embed(title="Yuka Коммандууд", description="Here is all of the commands for Yuka!", color=0x9001a2)
    ...
    #embed.add_field(name="Misc Commands", value="!Support - Need Any Help With Yuka?")
    embed.set_footer(text="Yuka")
